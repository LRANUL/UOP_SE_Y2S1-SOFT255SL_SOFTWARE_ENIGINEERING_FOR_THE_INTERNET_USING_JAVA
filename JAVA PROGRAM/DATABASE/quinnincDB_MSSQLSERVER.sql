...
('200143748', 'Rachel', 'Rebecca', 'Reynolds', '4215 Vernon Place', 'Liverpool', 'TE000008', '2019-11-26 10:38:26.475'),
('200154387', 'Sansa', 'Ellen', 'Palmer', '59 South Circle', 'Birmingham', 'TE000007', '2019-11-26 10:38:26.475'),
('200156724', 'Rob', 'Felix', 'Parker', '6 Namekagon Crossing', 'Birmingham', 'TE000010', '2019-11-26 10:38:26.475'),
('200531848', 'Rohan', 'Wade', 'Anderson', '47 Coleman Crossing', 'Liverpool', 'TE000005', '2019-11-27 10:38:26.475'),
('248416164', 'Olivia', 'Jane', 'Fletcher', '25 Pearson Pass', 'Birmingham', 'TE000002', '2019-11-27 10:38:26.475'),
('345343437', 'William', 'Merle', 'Stark', '32 Carberry Lane', 'Liverpool', 'TE000009', '2019-11-27 10:38:26.475'),
('415648413', 'Franklin', 'Arden', 'Bradley', '648 Trailsway Trail', 'Birmingham', 'TE000004', '2019-11-28 10:38:26.475'),
('443451257', 'Jace', 'Murphy', 'Adams', '18 Oneill Road', 'Birmingham', 'TE000007', '2019-11-29 10:38:26.475'),
('489481361', 'Jacob', 'Francis', 'Johnson', '23 Tennessee Center', 'Birmingham', 'TE000010', '2019-11-29 10:38:26.475'),
...
-- Creating Table 19 - CustomerTransactionDeposit
CREATE TABLE CustomerTransactionDeposit(
  ...
  tTellerID_ProcessedBy CHAR(8) NOT NULL,
  ...
  CONSTRAINT CHK_CTD_TellerID_Length CHECK (LEN(tTellerID_ProcessedBy) = 8)
)

GO

-- Trigger 1 - Table 19 - CustomerTransactionDeposit
...
-- Inserting records to Table 19 - CustomerTransactionDeposit, for Normal Savings Account Type
...
-- Inserting records to Table 19 - CustomerTransactionDeposit, for Bonus Savings Account Type
INSERT INTO CustomerTransactionDeposit
(TransactionAmount, TransactionDateTime, tsTransactionStatusID, absBSAccountNumber, tTellerID_ProcessedBy)
VALUES
('350.10', '2019-11-25 11:36:48.369', 'TS000001', '45000001', 'TE000002'), -- DTransactionNumber: 22000008
('600.50', '2019-11-26 12:43:25.458', 'TS000001', '45000002', 'TE000006'), -- DTransactionNumber: 22000009
('600.50', '2019-11-26 12:43:25.458', 'TS000001', '45000003', 'TE000003'), -- DTransactionNumber: 22000010
('350.50', '2019-11-26 12:43:25.458', 'TS000001', '45000004', 'TE000006'), -- DTransactionNumber: 22000011
('440.50', '2019-11-26 12:43:25.458', 'TS000001', '45000005', 'TE000007')  -- DTransactionNumber: 22000012

GO

-- Inserting records to Table 19 - CustomerTransactionDeposit, for Premier Savings Account Type
INSERT INTO CustomerTransactionDeposit
...
-- Crating Table 20 - CustomerTransactionWithdrawal
CREATE TABLE CustomerTransactionWithdrawal(
  ...
  CONSTRAINT CHK_CTW_TellerID_Length CHECK (LEN(tTellerID_ProcessedBy) = 8)
)

GO

-- Trigger 2 - Table 20 - CustomerTransactionWithdrawal
...
-- Inserting records to Table 20 - CustomerTransactionWithdrawal, for Normal Savings Account Type
INSERT INTO CustomerTransactionWithdrawal
(TransactionAmount, TransactionDateTime, ctTransactionStatusID, ansNSAccountNumber, tTellerID_ProcessedBy)
VALUES
('50.50', '2019-11-27 09:47:41.259', 'TS000001', '25000001', 'TE000001'),  -- WTransactionNumber: 44000001
('40.50', '2019-11-27 12:45:42.356', 'TS000001', '25000002', 'TE000003'),  -- WTransactionNumber: 44000002
('60.50', '2019-11-28 13:26:36.412', 'TS000001', '25000003', 'TE000005')   -- WTransactionNumber: 44000003

GO

-- Inserting records to Table 20 - CustomerTransactionWithdrawal, for Bonus Savings Account Type
INSERT INTO CustomerTransactionWithdrawal
(TransactionAmount, TransactionDateTime, ctTransactionStatusID, absBSAccountNumber, tTellerID_ProcessedBy)
VALUES
('50.10', '2019-11-27 10:36:32.954', 'TS000001', '45000001', 'TE000002')  -- WTransactionNumber: 44000004

GO

-- Inserting records to Table 20 - CustomerTransactionWithdrawal, for Premier Savings Account Type
INSERT INTO CustomerTransactionWithdrawal
...
-- Inserting records to Table 21 - Manager
...
-- Creating Table 23 - ModificationStatus
...
-- Inserting records to Table 23 - ModificationStatus
...
-- Creating Table 24 - TellerManageCustomer
...
-- Inserting records to Table 24 - TellerManageCustomer
...
-- Creating Table 25 -	ManagerManageAccountNormalSavings
...
-- Inserting records to Table 25 - ManagerManageAccountNormalSavings
...
-- Creating Table 26 - ManagerManageAccountBonusSavings
...
-- Inserting records to Table 26 - ManagerManageAccountBonusSavings
...
-- Creating Table 27 - ManagerManageAccountPremierSavings
...
-- Inserting records to Table 27 - ManagerManageAccountPremierSavings
...
-- Creating Table 28 -	ManagerManageCustomerTransactionDeposit
...
-- Inserting records to Table 28 - ManagerManageCustomerTransactionDeposit
INSERT INTO ManagerManageCustomerTransactionDeposit VALUES
('MA000001', '22000003', '2019-12-17 09:32:45.323', 3)

GO

-- Creating Table 29 - 	ManagerManageCustomerTransactionWithdrawal
...
-- Inserting records to Table 29 - ManagerManageCustomerTransactionWithdrawal
INSERT INTO ManagerManageCustomerTransactionWithdrawal VALUES
('MA000002', '44000003', '2019-12-13 13:04:24.323', 4)

GO

-- Creating Table 30 -	SystemAdministratorManageSystemLogin
...
-- Inserting records to Table 30 - SystemAdministratorManageSystemLogin
